<?php
 ...
 $var_value = $_GET['category_id'];
 $query = "SELECT * FROM final_prod WHERE category_id=$var_value";
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  <div class="dropdown-menu" aria-labelledby="dropdown04">
				...
				<a class="dropdown-item" href="index.php?category_id=8">Kurta Set</a>
		...
		<li class="nav-item dropdown active">
			  ...
			  <div class="dropdown-menu" aria-labelledby="dropdown04">
			  <a class="dropdown-item" href="index.php?category_id=9">View All.</a>
			  <a class="dropdown-item" href="Formal Suits.html"></a>
			  <a class="dropdown-item" href="Formal Suits.html"></a>
			  <a class="dropdown-item" href="Formal Suits.html"></a>
			  <a class="dropdown-item" href="Formal Suits.html"></a>
		  </ul>
...
<?php $i = 0; while ($row = mysqli_fetch_assoc($result)) { ?>
    <td>
								...
								<div class="product ftco-animate">
									<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/wedding/<?php $main_image = $row['main_img']; echo "<img src='images/$main_image' " ?>')">
									<img src="images/wedding/<?php echo $row['main_img']; $b= $row['prod_id']   ?> "alt="" width="300" height="400"  >
										<div class="desc">
											<p class="meta-prod d-flex">
                                                <a href="mens.php?varname=<?php echo $row['prod_id']  ?>" class="d-flex align-items-center justify-content-center"><span class="flaticon-visibility"></span></a><div style="background-image: url('/images/wedding/<?php $main_image = $row['main_img']; echo "<img src='images/$main_image' " ?>')">
                                            </div>
									...
									<div class="text text-center">
										...
										<h2><?php echo $row['name']; ?></h2><a href="Men's Black Twill Extra Slim Fit Suit With Two Front Buttons.html"  class="category"><?php echo $row['uni_id'];?></a></li>
