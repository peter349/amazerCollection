    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      ...
      <p><?php echo $row['uni_id'];?></p>
                  ...
                  <p>*Get A Complimentary MATCHING FACE MASK With Every Purchase. </p>
                            	<p><a href="cart.html" class="btn btn-primary py-3 px-5 mr-2">fill the form</a><a href="index.php?category_id=9" class="btn btn-primary py-3 px-5">Explore Fabrics</a></p>

    </div>
        <div class="image-viewer">
          <div class="main-image">
            <img src="images/wedding/<?php echo $row['main_img'];  ?> "alt=""  >
